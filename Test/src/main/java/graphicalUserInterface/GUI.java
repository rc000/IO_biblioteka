...
import podsystemZarzadzaniaKontem.Klienci;
import podsystemZarzadzaniaKontem.Klient;
...
import podsystemZarzadzaniaKsiazkami.Ksiazki;
import podsystemZarzadzaniaKsiazkami.Status;
 public class GUI {
	...
	public boolean zaloguj_admin(String login,String password)  
	{
		...
		{
			if(password.equals(admin.getHaslo()))
			{
 					return true;
...
//Gettery i settery
	...
	public boolean znajdz_uzytkownika(String login)
	{
	 ...
	 {
		 List<Ksiazka> znalezione=new Vector<Ksiazka>();
		 for(Ksiazka k:ksiazki.getLista())
		 {
